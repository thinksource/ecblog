 ...
 */
ProductCol = new orion.collection('products', {
  singularName: orion.helpers.getTranslation('ProductCol.singularName'), // The name of one of this items
  pluralName: orion.helpers.getTranslation('ProductCol.pluralName'), // The name of more than one of this items
  title: orion.helpers.getTranslation('ProductCol.title'), // The title of the page
  link: {
    /**
     ...
     */
    title: orion.helpers.getTranslation('ProductCol.title')
  },
  /**
  ...
  tabular: {
    columns: [
      ...
      orion.attributeColumn('summernote', 'body', orion.helpers.getTranslation('ProductCol.schema.description')),
...
ProductCol.attachSchema(new SimpleSchema({
  ...
  image: orion.attribute('image', {
      label: orion.helpers.getTranslation('ProductCol.schema.image'), // We use this function to make i18n work in autoform
      optional: true
  }),
  /**
  ...
  body: orion.attribute('summernote', {
      label: orion.helpers.getTranslation('ProductCol.schema.description') // We use this function to make i18n work in autoform
  }),
  /**
